...
<html lang="en">
    ...
    <body>
        ...
        <nav class="main-nav">
            <div class="container container--flex">
                ...
                <ul class="menu" id="menu">
                    ...
                    <li class="menu__item"><a href="busqueda.php" class="menu__link  menu__link--select">Busqueda</a></li>
        ...
        <form action="busqueda.php" method="post" class="filtros">
            <div>
                <p class="title-filtrar">Filtrar por:</p>
                <input id="filtro_fech_ini" name="filtro_fech_ini" type="checkbox" class="check">
                <label for="filtro">Fecha Inicial</label>

                <input id="filtro_fech_fin" name="filtro_fech_fin" type="checkbox" class="check">
                <label for="filtro">Fecha Final</label>

                <input id="filtro_categorias" name="filtro_categorias" type="checkbox" class="check">
                <label for="filtro">Categorías</label>

                <input id="filtro_nom_usu" name="filtro_nom_usu" type="checkbox" class="check">
                <label for="filtro">Usuario</label>

                <input id="filtro_nom_cur" name="filtro_nom_cur" type="checkbox" class="check">
        ...
        <section class="group mas-vendidos">
            <div class="container container--flex">
              ...
              if ($columna == "cursos_vendidos" && $valor != null) {  $cursos_vendidos = $valor; }
                    ...
                    <input class="mas-vendidos__boton" type="submit" data-id="<?php echo $i; ?>" onclick="aviso();" value="Agregar al Carrito">
                </div> <?php $i++;} ?><br>
            </div>
        </section>
        ...
        <?php for ($p = 1; $p<=$total_paginas;$p++)  { ?>
                <li><a href="pagina_busqueda.php?param1=<?php echo $fecha_ini; ?>&param2=<?php echo $fecha_fin; ?>&param3=<?php echo $categoria_peticion; ?>&param4=<?php echo $nom_usu; ?>&param5=<?php echo $nom_cur; ?>&param6=<?php echo $p; ?>"><?php echo $p; ?></a></li>
            <?php } ?>
        </ul>
        </section>
