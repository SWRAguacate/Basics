        ...
        <section class="group mas-recientes">
            ...
            <?php
              ...
              if ($columna == "cursos_vendidos" && $valor != null) {  $cursos_vendidos = $valor; }
                    ...
                    <input class="mas-recientes__boton" type="submit" data-id="<?php echo $i; ?>" onclick="aviso();" value="Agregar al Carrito">
                </div><?php $i++;} ?>
            </div>
        </section>
        ...
        <section class="group mejor-calificados">
            ...
            <div class="container container--flex">
              ...
              if ($columna == "cursos_vendidos" && $valor != null) {  $cursos_vendidos = $valor; }
                    ...
                    <input class="mejor-calificado__boton" type="submit" data-id="<?php echo $i; ?>" onclick="aviso();" value="Agregar al Carrito">
                </div><?php $i++;} ?>
            </div>
        </section>
